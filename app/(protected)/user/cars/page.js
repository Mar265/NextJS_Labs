...
//   const [cars, setCars] = useState([]); // Przechowywanie listy samochodów
...
//   useEffect(() => {
//     // Pobieranie listy samochodów dla użytkownika
...
//         <ul className="mt-4">
//           {cars.map((car) => (
//             <li key={car.id} className="border-b border-gray-300 py-2">
...
// export default CarsPage;'use client';
'use client';
import { useAuth } from '@/app/lib/firebase/AuthContext';
import { getAuth } from 'firebase/auth';
import { collection, getDocs, query, where, addDoc } from 'firebase/firestore';
